        ...
        <div class='col-md-8 col-md-offset-2'>
            <div class='panel panel-primary'>
                ...
                <div class='panel-heading'>
                    <h3 class='text-center'>Listado de respuestas agregadas a la pregunta {{$question->id}}: <br> <strong>"{{$question->question_text}}".</strong></h3>
                    @if($answers->count() > 0)
                        <table class='table'>
                            <tr>
                        ...
                        <a href="admin/tests/index" class='btn btn-md btn-primary'>Guardar</a>
                    @else
